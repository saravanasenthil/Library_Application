    ...
    return (
        <div>
            ...
            <div className="admin-dashboard-container">
                ...
                <div className="card-3" onClick={() => handleCardClick('userBookRelation')}>
                    <h3>Manage User & Book</h3>
                </div>
            </div>

            {selectedCard === 'allUsers' && <AllUsersCard onRequestClose={handleCloseModal}  />}
            {selectedCard === 'allBooks' && <AllBooksCard onRequestClose={handleCloseModal} isOpen={false} />}
            {selectedCard === 'userBookRelation' && <UserBookRelationCard onRequestClose={handleCloseModal} isOpen={false} />}
        </div>
    );
};
